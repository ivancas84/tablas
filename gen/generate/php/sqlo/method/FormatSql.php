...
protected function start(){
  ...
  public function formatSql(array \$row){
    \$sqlFormat = new SqlFormat(\$this->db);
    \$row_ = array();
";   
  ...
  protected function pk(){
    ...
    switch ( $field->getDataType()) {
      case "integer":
        $this->string .= "    \$row_['" . $field->getName() . "'] = \$sqlFormat->positiveIntegerWithoutZerofill(\$row['" . $field->getName() . "']);
";        
      break;
      case "string": 
        $this->string .= "    \$row_['" . $field->getName() . "'] = \$sqlFormat->escapeString(\$row['" . $field->getName() . "']);
";          
      break;    
  ...
  protected function integerNonZero(Field $field){
    ...
    $this->string .= "    if(isset(\$row['" . $field->getName() . "']) ) \$row_['" . $field->getName() . "'] = \$sqlFormat->positiveIntegerWithoutZerofill(\$row['" . $field->getName() . "']);
";
  ...
  protected function number(Field $field){
    ...
    $this->string .= "    if(isset(\$row['" . $field->getName() . "'])) \$row_['" . $field->getName() . "'] = \$sqlFormat->numeric(\$row['" . $field->getName() . "']);
";
  ...
  protected function timestamp(Field $field){
    ...
    $this->string .= "    if(isset(\$row['" . $field->getName() . "'])) \$row_['" . $field->getName() . "'] = \$sqlFormat->timestamp(\$row['" . $field->getName() . "']);
";
  }
  ...
  protected function time(Field $field){
    $this->string .= "    if(isset(\$row['" . $field->getName() . "'])) \$row_['" . $field->getName() . "'] = \$sqlFormat->time(\$row['" . $field->getName() . "']);
";
  ...
  protected function date(Field $field){
    ...
    $this->string .= "    if(isset(\$row['" . $field->getName() . "'])) \$row_['" . $field->getName() . "'] = \$sqlFormat->date(\$row['" . $field->getName() . "']);
";
  ...
  protected function year(Field $field){
    $this->string .= "    if(isset(\$row['" . $field->getName() . "'])) \$row_['" . $field->getName() . "'] = \$sqlFormat->year(\$row['" . $field->getName() . "']);
";
  ...
  protected function string(Field $field){    
      ...
      $this->string .= "    if(isset(\$row['" . $field->getName() . "'])) \$row_['" . $field->getName() . "'] = \$sqlFormat->escapeString(\$row['" . $field->getName() . "']);
";
  ...
  protected function boolean(Field $field){
    ...
    $this->string .= "    if(isset(\$row['" . $field->getName() . "'])) \$row_['" . $field->getName() . "'] = \$sqlFormat->boolean(\$row['" . $field->getName() . "']);
";
  }
