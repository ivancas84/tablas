...
<form [formGroup]=\"adminForm\" (ngSubmit)=\"onSubmit()\" novalidate>
  <app-" . $this->getEntity()->getName("xx-yy") . "-fieldset [adminForm]=\"adminForm\" [sync]=\"sync\" [row]=\"data\" (changeFieldset)=\"resetForm(\$event)\"></app-" . $this->getEntity()->getName("xx-yy") . "-fieldset>
