...
" ;
  ...
  protected function attributes(){
    ...
    $this->string .= "
  protected \$type = \"" . $this->fieldInfo["data_type"] . "\";
  protected \$fieldType = \"" . $this->fieldInfo["field_type"] . "\";
  protected \$unique = " . $unique . ";
  protected \$notNull = " . $not_null . ";
  protected \$default = " . $default . ";
  protected \$length = " . $length . ";
  protected \$main = " . $main . ";
    
  public static function name() { return  \"" . $this->fieldInfo["field_name"] . "\"; }
  public static function alias() { return  \"" . $this->fieldInfo["alias"] . "\"; }
