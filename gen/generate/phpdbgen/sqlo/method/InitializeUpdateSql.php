...
class InitializeUpdateSql extends GenerateEntity{

protected function start(){
    $this->string .= "
  //@override
  public function initializeUpdateSql(array \$data){
";
  ...
  protected function nf(Entity $entity){
    ...
    foreach ( $nf as $field ) {
      switch ( $field->getSubtype()) {
        ...
        case "string": case "text": case "password": case "textarea": $this->string($field); break;
        case "integer": case "float": $this->number($field); break;
        case "boolean": case "checkbox": $this->boolean($field); break;
      }
    }
    unset ( $field );
  }
