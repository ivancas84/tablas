...
";
  ...
  protected function fk(array $fk, array $tablesVisited, $tableAux, $prefixAux){
    foreach ($fk as $field ) {    
      ...
      $this->string .= "LEFT OUTER JOIN \" .  " . $field->getEntityRef()->getName("XxYy") .  "Entity::sn_() . " . "\" AS " . $prefixTemp . " ON (" . $tableAux . $field->getName() . " = " . $prefixTemp . "." . $pk->getName() . ")
" ;      
  ...
  protected function u_(array $u_, array $tablesVisited, $tableAux, $prefixAux){    
    foreach ($u_ as $field ) {
      ...
      $this->string .= "LEFT OUTER JOIN \" . " . $field->getEntity()->getName("XxYy") .  "Entity::sn_() . \" AS " . $prefixTemp . " ON (" . $tableAux . $pk->getName() . " = " . $prefixTemp . "." . $field->getName() . ")
" ;
